...
@PK({"GATEWAY_ID","DEVICE_ID"})
public class GATEWAY_DEVICEObj implements java.io.Serializable,com.google.gwt.user.client.rpc.IsSerializable,
  ...
  */
  ...
  /**
     * 表明. 
     */
  public static final String TBL_GATEWAY_DEVICE="GATEWAY_DEVICE";
  public GATEWAY_DEVICEObj() {
  }
  /**
   * 根据字段名称获取字段的值. 
   */
