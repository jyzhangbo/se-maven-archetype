...
@Table("DEVICE_RULE_COPY")
public class DEVICE_RULE_COPYObj implements java.io.Serializable,com.google.gwt.user.client.rpc.IsSerializable,
  ...
  */
  ...
  /**
     * 表明. 
     */
  public static final String TBL_DEVICE_RULE_COPY="DEVICE_RULE_COPY";
  public DEVICE_RULE_COPYObj() {
  }
  /**
   * 根据字段名称获取字段的值. 
   */
