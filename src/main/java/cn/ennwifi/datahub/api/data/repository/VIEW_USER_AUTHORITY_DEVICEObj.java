 ...
 *         GATEWAY_USER_ID    Long<br/>
 *         DEVICE_TYPE_NAME   设备类型名称 String<br/>
 *         AUTHORITY_USER_TYPE   登录类型 Integer<br/>
 *         AUTHORITY_USER_HASH   哈希值 String<br/>
 *         AUTHORITY_USER_LOGIN_NAME   用户登录唯一名称标识 String<br/>
 *         AUTHORITY_USER_NAME   真实姓名 String<br/>
 *         AUTHORITY_USER_GENDER   性别 String<br/>
 *         AUTHORITY_USER_EMAIL   邮箱 String<br/>
 *         AUTHORITY_USER_MOBILE   手机 String<br/>
 *         AUTHORITY_USER_TITLE   用户说明 String<br/>
 *         AUTHORITY_USER_TOKEN   登录的TOKEN String<br/>
 *         AUTHORITY_USER_CREATE_TIME    java.sql.Timestamp<br/>
 *         AUTHORITY_USER_UPDATE_TIME    java.sql.Timestamp<br/>
 */

@Table("VIEW_USER_AUTHORITY_DEVICE")
public class VIEW_USER_AUTHORITY_DEVICEObj implements java.io.Serializable,com.google.gwt.user.client.rpc.IsSerializable,
  ...
  */
  ...
  /**
     * 表明. 
     */
  public static final String TBL_VIEW_USER_AUTHORITY_DEVICE="VIEW_USER_AUTHORITY_DEVICE";
  public VIEW_USER_AUTHORITY_DEVICEObj() {
  }
  /**
   * 根据字段名称获取字段的值. 
   */
  ...
  public Object getFieldValue(String fieldName,Integer fieldIndex) {
    if (fieldName != null && fieldName.length() > 0) {
      ...
      if (FLD_AUTHORITY_USER_ID.equals(fieldName)) {
      ...
      if (FLD_GATEWAY_USER_ID.equals(fieldName)) {
        return GATEWAY_USER_ID;
      }
      if (FLD_DEVICE_TYPE_NAME.equals(fieldName)) {
        return DEVICE_TYPE_NAME;
      }
      if (FLD_AUTHORITY_USER_TYPE.equals(fieldName)) {
        return AUTHORITY_USER_TYPE;
      }
      if (FLD_AUTHORITY_USER_HASH.equals(fieldName)) {
        return AUTHORITY_USER_HASH;
      }
      if (FLD_AUTHORITY_USER_LOGIN_NAME.equals(fieldName)) {
        return AUTHORITY_USER_LOGIN_NAME;
      }
      if (FLD_AUTHORITY_USER_NAME.equals(fieldName)) {
        return AUTHORITY_USER_NAME;
      }
      if (FLD_AUTHORITY_USER_GENDER.equals(fieldName)) {
        return AUTHORITY_USER_GENDER;
      }
      if (FLD_AUTHORITY_USER_EMAIL.equals(fieldName)) {
        return AUTHORITY_USER_EMAIL;
      }
      if (FLD_AUTHORITY_USER_MOBILE.equals(fieldName)) {
        return AUTHORITY_USER_MOBILE;
      }
      if (FLD_AUTHORITY_USER_TITLE.equals(fieldName)) {
        return AUTHORITY_USER_TITLE;
      }
      if (FLD_AUTHORITY_USER_TOKEN.equals(fieldName)) {
        return AUTHORITY_USER_TOKEN;
      }
      if (FLD_AUTHORITY_USER_CREATE_TIME.equals(fieldName)) {
        return AUTHORITY_USER_CREATE_TIME;
      }
      if (FLD_AUTHORITY_USER_UPDATE_TIME.equals(fieldName)) {
        return AUTHORITY_USER_UPDATE_TIME;
      }
    } else if (fieldIndex != null && fieldIndex >= 0 && fieldIndex < 51) {
      if (fieldIndex == 0) {
        return DEVICE_ID;
      }
      if (fieldIndex == 1) {
  ...
  */
  ...
  /**
   * 字段AUTHORITY_USER_ID在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_ID="AUTHORITY_USER_ID";

  /**
   * 获取字段AUTHORITY_USER_ID的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_ID=1;

 /**
   * 字段AUTHORITY_USER_ID.
   */
  private Long AUTHORITY_USER_ID;

  /**
   * 返回字段AUTHORITY_USER_ID的值.
   * @return AUTHORITY_USER_ID    bigint
  */
  public Long getAUTHORITY_USER_ID() {
    return AUTHORITY_USER_ID;
  }

  /**
   * 设置字段AUTHORITY_USER_ID的值.
   * @param authority_user_id    bigint
   */
  public void setAUTHORITY_USER_ID(Long authority_user_id) {
    this.AUTHORITY_USER_ID=authority_user_id;
  }
   ...
   * 获取字段GATEWAY_ID的索引值.
   */
  public static final Integer IDX_GATEWAY_ID=2;
  ...
  */
   ...
   */
  public static final Integer IDX_GATEWAY_DEVICE_BINDTIME=3;
  ...
  */
   ...
   */
  public static final Integer IDX_GATEWAY_NAME=4;
  ...
  */
   ...
   */
  public static final Integer IDX_GATEWAY_CTIME=5;
  ...
  */
   ...
   */
  public static final Integer IDX_GATEWAY_UPDATE_TIME=6;
  ...
  */
   ...
   */
  public static final Integer IDX_GATEWAY_STATE=7;
  ...
  */
   ...
   */
  public static final Integer IDX_GATEWAY_TOKEN=8;
  ...
  */
   ...
   */
  public static final Integer IDX_GATEWAY_ADDRESS=9;
  ...
  */
   ...
   */
  public static final Integer IDX_GATEWAY_TYPE=10;
  ...
  */
   ...
   * 获取字段GATEWAY_VER的索引值.
   */
  public static final Integer IDX_GATEWAY_VER=11;
  ...
  */
   ...
   * 获取字段DEVICE_NO的索引值.
   */
  public static final Integer IDX_DEVICE_NO=12;
  ...
  */
   ...
   */
  public static final Integer IDX_DEVICE_CTIME=13;
  ...
  */
   ...
   */
  public static final Integer IDX_REGISTER_START=14;
  ...
  */
   ...
   */
  public static final Integer IDX_PROTOCOL_TYPE_ID=15;
  ...
  */
   ...
   */
  public static final Integer IDX_PROTOCOL_LENGTH=16;
  ...
  */
   ...
   * 获取字段DEVICE_NAME的索引值.
   */
  public static final Integer IDX_DEVICE_NAME=17;
  ...
  */
   ...
   */
  public static final Integer IDX_DEVICE_TYPE_ID=18;
  ...
  */
   ...
   */
  public static final Integer IDX_DEVICE_UPDATE_TIME=19;
  ...
  */
   ...
   */
  public static final Integer IDX_ORDER_IN_GATEWAY=20;
  ...
  */
   ...
   */
  public static final Integer IDX_DATA_FIRST_TIME=21;
  ...
  */
   ...
   */
  public static final Integer IDX_DATA_LAST_TIME=22;
  ...
  */
   ...
   */
  public static final Integer IDX_IS_NOTIFY_USER=23;
  ...
  */
   ...
   */
  public static final Integer IDX_USER_GATEWAY_BINDTIME=24;
  ...
  */
   ...
   * 获取字段USER_TYPE的索引值.
   */
  public static final Integer IDX_USER_TYPE=25;
  ...
  */
   ...
   * 获取字段USER_HASH的索引值.
   */
  public static final Integer IDX_USER_HASH=26;
  ...
  */
   ...
   */
  public static final Integer IDX_USER_LOGIN_NAME=27;
  ...
  */
   ...
   */
  public static final Integer IDX_USER_REAL_NAME=28;
  ...
  */
   ...
   * 获取字段USER_AVATOR的索引值.
   */
  public static final Integer IDX_USER_AVATOR=29;
  ...
  */
   ...
   * 获取字段USER_GENDER的索引值.
   */
  public static final Integer IDX_USER_GENDER=30;
  ...
  */
   ...
   * 获取字段USER_EMAIL的索引值.
   */
  public static final Integer IDX_USER_EMAIL=31;
  ...
  */
   ...
   * 获取字段USER_MOBILE的索引值.
   */
  public static final Integer IDX_USER_MOBILE=32;
  ...
  */
   ...
   * 获取字段USER_TITLE的索引值.
   */
  public static final Integer IDX_USER_TITLE=33;
  ...
  */
   ...
   * 获取字段USER_TOKEN的索引值.
   */
  public static final Integer IDX_USER_TOKEN=34;
  ...
  */
   ...
   */
  public static final Integer IDX_USER_CREATE_TIME=35;
  ...
  */
   ...
   */
  public static final Integer IDX_USER_UPDATE_TIME=36;
  ...
  */
   ...
   */
  public static final Integer IDX_IS_SEND_MESSAGE=37;
  ...
  */
  ...
  /**
   * 字段GATEWAY_USER_ID在数据中的名称.
   */
  public static final String FLD_GATEWAY_USER_ID="GATEWAY_USER_ID";

  /**
   * 获取字段GATEWAY_USER_ID的索引值.
   */
  public static final Integer IDX_GATEWAY_USER_ID=38;

 /**
   * 字段GATEWAY_USER_ID.
   */
  private Long GATEWAY_USER_ID;

  /**
   * 返回字段GATEWAY_USER_ID的值.
   * @return GATEWAY_USER_ID    bigint
  */
  public Long getGATEWAY_USER_ID() {
    return GATEWAY_USER_ID;
  }

  /**
   * 设置字段GATEWAY_USER_ID的值.
   * @param gateway_user_id    bigint
   */
  public void setGATEWAY_USER_ID(Long gateway_user_id) {
    this.GATEWAY_USER_ID=gateway_user_id;
  }
   ...
   */
  public static final Integer IDX_DEVICE_TYPE_NAME=39;
  ...
  */
  ...
  /**
   * 字段AUTHORITY_USER_TYPE在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_TYPE="AUTHORITY_USER_TYPE";

  /**
   * 获取字段AUTHORITY_USER_TYPE的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_TYPE=40;

 /**
   * 字段AUTHORITY_USER_TYPE.
   */
  private Integer AUTHORITY_USER_TYPE;

  /**
   * 返回字段AUTHORITY_USER_TYPE的值.
   * @return AUTHORITY_USER_TYPE  登录类型  int
  */
  public Integer getAUTHORITY_USER_TYPE() {
    return AUTHORITY_USER_TYPE;
  }

  /**
   * 设置字段AUTHORITY_USER_TYPE的值.
   * @param authority_user_type  登录类型  int
   */
  public void setAUTHORITY_USER_TYPE(Integer authority_user_type) {
    this.AUTHORITY_USER_TYPE=authority_user_type;
  }

  /**
   * 字段AUTHORITY_USER_HASH在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_HASH="AUTHORITY_USER_HASH";

  /**
   * 获取字段AUTHORITY_USER_HASH的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_HASH=41;

 /**
   * 字段AUTHORITY_USER_HASH.
   */
  private String AUTHORITY_USER_HASH;

  /**
   * 返回字段AUTHORITY_USER_HASH的值.
   * @return AUTHORITY_USER_HASH  哈希值  varchar
  */
  public String getAUTHORITY_USER_HASH() {
    return AUTHORITY_USER_HASH;
  }

  /**
   * 设置字段AUTHORITY_USER_HASH的值.
   * @param authority_user_hash  哈希值  varchar
   */
  public void setAUTHORITY_USER_HASH(String authority_user_hash) {
    this.AUTHORITY_USER_HASH=authority_user_hash;
  }

  /**
   * 字段AUTHORITY_USER_LOGIN_NAME在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_LOGIN_NAME="AUTHORITY_USER_LOGIN_NAME";

  /**
   * 获取字段AUTHORITY_USER_LOGIN_NAME的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_LOGIN_NAME=42;

 /**
   * 字段AUTHORITY_USER_LOGIN_NAME.
   */
  private String AUTHORITY_USER_LOGIN_NAME;

  /**
   * 返回字段AUTHORITY_USER_LOGIN_NAME的值.
   * @return AUTHORITY_USER_LOGIN_NAME  用户登录唯一名称标识  varchar
  */
  public String getAUTHORITY_USER_LOGIN_NAME() {
    return AUTHORITY_USER_LOGIN_NAME;
  }

  /**
   * 设置字段AUTHORITY_USER_LOGIN_NAME的值.
   * @param authority_user_login_name  用户登录唯一名称标识  varchar
   */
  public void setAUTHORITY_USER_LOGIN_NAME(String authority_user_login_name) {
    this.AUTHORITY_USER_LOGIN_NAME=authority_user_login_name;
  }

  /**
   * 字段AUTHORITY_USER_NAME在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_NAME="AUTHORITY_USER_NAME";

  /**
   * 获取字段AUTHORITY_USER_NAME的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_NAME=43;

 /**
   * 字段AUTHORITY_USER_NAME.
   */
  private String AUTHORITY_USER_NAME;

  /**
   * 返回字段AUTHORITY_USER_NAME的值.
   * @return AUTHORITY_USER_NAME  真实姓名  varchar
  */
  public String getAUTHORITY_USER_NAME() {
    return AUTHORITY_USER_NAME;
  }

  /**
   * 设置字段AUTHORITY_USER_NAME的值.
   * @param authority_user_name  真实姓名  varchar
   */
  public void setAUTHORITY_USER_NAME(String authority_user_name) {
    this.AUTHORITY_USER_NAME=authority_user_name;
  }

  /**
   * 字段AUTHORITY_USER_GENDER在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_GENDER="AUTHORITY_USER_GENDER";

  /**
   * 获取字段AUTHORITY_USER_GENDER的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_GENDER=44;

 /**
   * 字段AUTHORITY_USER_GENDER.
   */
  private String AUTHORITY_USER_GENDER;

  /**
   * 返回字段AUTHORITY_USER_GENDER的值.
   * @return AUTHORITY_USER_GENDER  性别  varchar
  */
  public String getAUTHORITY_USER_GENDER() {
    return AUTHORITY_USER_GENDER;
  }

  /**
   * 设置字段AUTHORITY_USER_GENDER的值.
   * @param authority_user_gender  性别  varchar
   */
  public void setAUTHORITY_USER_GENDER(String authority_user_gender) {
    this.AUTHORITY_USER_GENDER=authority_user_gender;
  }

  /**
   * 字段AUTHORITY_USER_EMAIL在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_EMAIL="AUTHORITY_USER_EMAIL";

  /**
   * 获取字段AUTHORITY_USER_EMAIL的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_EMAIL=45;

 /**
   * 字段AUTHORITY_USER_EMAIL.
   */
  private String AUTHORITY_USER_EMAIL;

  /**
   * 返回字段AUTHORITY_USER_EMAIL的值.
   * @return AUTHORITY_USER_EMAIL  邮箱  varchar
  */
  public String getAUTHORITY_USER_EMAIL() {
    return AUTHORITY_USER_EMAIL;
  }

  /**
   * 设置字段AUTHORITY_USER_EMAIL的值.
   * @param authority_user_email  邮箱  varchar
   */
  public void setAUTHORITY_USER_EMAIL(String authority_user_email) {
    this.AUTHORITY_USER_EMAIL=authority_user_email;
  }

  /**
   * 字段AUTHORITY_USER_MOBILE在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_MOBILE="AUTHORITY_USER_MOBILE";

  /**
   * 获取字段AUTHORITY_USER_MOBILE的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_MOBILE=46;

 /**
   * 字段AUTHORITY_USER_MOBILE.
   */
  private String AUTHORITY_USER_MOBILE;

  /**
   * 返回字段AUTHORITY_USER_MOBILE的值.
   * @return AUTHORITY_USER_MOBILE  手机  varchar
  */
  public String getAUTHORITY_USER_MOBILE() {
    return AUTHORITY_USER_MOBILE;
  }

  /**
   * 设置字段AUTHORITY_USER_MOBILE的值.
   * @param authority_user_mobile  手机  varchar
   */
  public void setAUTHORITY_USER_MOBILE(String authority_user_mobile) {
    this.AUTHORITY_USER_MOBILE=authority_user_mobile;
  }

  /**
   * 字段AUTHORITY_USER_TITLE在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_TITLE="AUTHORITY_USER_TITLE";

  /**
   * 获取字段AUTHORITY_USER_TITLE的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_TITLE=47;

 /**
   * 字段AUTHORITY_USER_TITLE.
   */
  private String AUTHORITY_USER_TITLE;

  /**
   * 返回字段AUTHORITY_USER_TITLE的值.
   * @return AUTHORITY_USER_TITLE  用户说明  varchar
  */
  public String getAUTHORITY_USER_TITLE() {
    return AUTHORITY_USER_TITLE;
  }

  /**
   * 设置字段AUTHORITY_USER_TITLE的值.
   * @param authority_user_title  用户说明  varchar
   */
  public void setAUTHORITY_USER_TITLE(String authority_user_title) {
    this.AUTHORITY_USER_TITLE=authority_user_title;
  }

  /**
   * 字段AUTHORITY_USER_TOKEN在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_TOKEN="AUTHORITY_USER_TOKEN";

  /**
   * 获取字段AUTHORITY_USER_TOKEN的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_TOKEN=48;

 /**
   * 字段AUTHORITY_USER_TOKEN.
   */
  private String AUTHORITY_USER_TOKEN;

  /**
   * 返回字段AUTHORITY_USER_TOKEN的值.
   * @return AUTHORITY_USER_TOKEN  登录的TOKEN  varchar
  */
  public String getAUTHORITY_USER_TOKEN() {
    return AUTHORITY_USER_TOKEN;
  }

  /**
   * 设置字段AUTHORITY_USER_TOKEN的值.
   * @param authority_user_token  登录的TOKEN  varchar
   */
  public void setAUTHORITY_USER_TOKEN(String authority_user_token) {
    this.AUTHORITY_USER_TOKEN=authority_user_token;
  }

  /**
   * 字段AUTHORITY_USER_CREATE_TIME在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_CREATE_TIME="AUTHORITY_USER_CREATE_TIME";

  /**
   * 获取字段AUTHORITY_USER_CREATE_TIME的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_CREATE_TIME=49;

 /**
   * 字段AUTHORITY_USER_CREATE_TIME.
   */
  private java.sql.Timestamp AUTHORITY_USER_CREATE_TIME;

  /**
   * 返回字段AUTHORITY_USER_CREATE_TIME的值.
   * @return AUTHORITY_USER_CREATE_TIME    timestamp
  */
  public java.sql.Timestamp getAUTHORITY_USER_CREATE_TIME() {
    return AUTHORITY_USER_CREATE_TIME;
  }

  /**
   * 设置字段AUTHORITY_USER_CREATE_TIME的值.
   * @param authority_user_create_time    timestamp
   */
  public void setAUTHORITY_USER_CREATE_TIME(java.sql.Timestamp authority_user_create_time) {
    this.AUTHORITY_USER_CREATE_TIME=authority_user_create_time;
  }

  /**
   * 字段AUTHORITY_USER_UPDATE_TIME在数据中的名称.
   */
  public static final String FLD_AUTHORITY_USER_UPDATE_TIME="AUTHORITY_USER_UPDATE_TIME";

  /**
   * 获取字段AUTHORITY_USER_UPDATE_TIME的索引值.
   */
  public static final Integer IDX_AUTHORITY_USER_UPDATE_TIME=50;

 /**
   * 字段AUTHORITY_USER_UPDATE_TIME.
   */
  private java.sql.Timestamp AUTHORITY_USER_UPDATE_TIME;

  /**
   * 返回字段AUTHORITY_USER_UPDATE_TIME的值.
   * @return AUTHORITY_USER_UPDATE_TIME    timestamp
  */
  public java.sql.Timestamp getAUTHORITY_USER_UPDATE_TIME() {
    return AUTHORITY_USER_UPDATE_TIME;
  }

  /**
   * 设置字段AUTHORITY_USER_UPDATE_TIME的值.
   * @param authority_user_update_time    timestamp
   */
  public void setAUTHORITY_USER_UPDATE_TIME(java.sql.Timestamp authority_user_update_time) {
    this.AUTHORITY_USER_UPDATE_TIME=authority_user_update_time;
  }
